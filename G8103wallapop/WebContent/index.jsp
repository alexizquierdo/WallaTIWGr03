            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <div class="single-slide">
						...
						de la que disponemos te asegura encontrar cualquier producto seg&uacute;n a tus necesidades.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                ...
                                                <p>Sin gastos de env&iacute;o, busca todo lo que necesites...</p>
						<p>&iexcl;Sin moverte de casa, trabajo o desde el m&oacute;vil!</p>
                                                <a href="shop.jsp" class="readmore">Ver productos</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="slide-text">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2>&iexcl;Ventas 100% aseguradas!</h2>
                                                <p>&iquest;A qu&eacute; est&aacute;s esperando?</p>
                                                <a href="shop.jsp" class="readmore">shop more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
